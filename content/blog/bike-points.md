...
# Cover: {static}/blog/img/bike-points/point-86.jpg
Slug: bike-points
---
...
![Image of a bike point. The sign indicates that viewers are at point 86. They can go straight to reach point 85, or turn left to reach point 81.]({static}/blog/img/bike-points/point-86.jpg)
...
![A free-standing regional map, showing the area and bike points around point 86.]({static}/blog/img/bike-points/map-86.jpg)
...
![Map of Boston. Key intersections are numbered. There are highlighted routes between those intersections.]({static}/blog/img/bike-points/full-boston-map.png)
...
![An illustration of intermediate point removal. \(\*\) - \(\*\) - \(\*\) -> \(\*\) - \(\*\)]({static}/blog/img/bike-points/pruning-nodes.png)
...
![bike point sign design. It has three rows. In each row, there are two spaces for stickers - one to indicate the point, and another to indicate direction.]({static}/blog/img/bike-points/sign-large.png)
![bike point sign designs. Both signs are the same 6" x 8" size. One sign has two rows, with 4 corresponding stickers. The other sign has no rows, and two vertical positions for stickers.]({static}/blog/img/bike-points/sign-small.png)
...
![material cost breakdown of bike points]({static}/blog/img/bike-points/costs.png)
